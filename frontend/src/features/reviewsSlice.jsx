...
// API URLs
const createReviewUrl = "http://localhost:7000/api/reviews/createReview";
const updateReviewUrl = "http://localhost:7000/api/reviews/updateReview";
const deleteReviewUrl = "http://localhost:7000/api/reviews/deleteReview";
const getAllReviewsByProductUrl =
  "http://localhost:7000/api/reviews/getAllReviewsByProduct";
